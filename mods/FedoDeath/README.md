...
Death shouldn't be free. Instead of your tombstone appearing the instant you die, a
hostile guardian spawns where you fell and stands over your loot. For the gif posted to
Discord on death, see the companion mod
[FedoDeathGif](../FedoDeathGif/README.md) — split out, no shared logic between the two.
...
- All settings are synced from the server and locked ([ServerSync](https://github.com/blaxxun-boop/ServerSync)) -- a connecting player can't override them from their own local `.cfg`, since they affect what everyone on the server sees.
